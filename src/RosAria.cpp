...
//  }
  ...
  tf::Transform baseFootPrintTF;
  baseFootPrintTF.setOrigin(tf::Vector3(0., 0., 0.));
  tf::Quaternion q;
  q.setRPY(0, 0, 0);
  baseFootPrintTF.setRotation(q);
  odom_broadcaster.sendTransform(tf::StampedTransform(baseFootPrintTF, ros::Time::now(), "base_link", "base_footprint"));
